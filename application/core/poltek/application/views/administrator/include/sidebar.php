...
<a href="<?php echo base_url() . $this->uri->segment(1); ?>" class="brand-link navbar-light">
  <img src="<?php echo base_url(); ?>/asset/logo/admin.png" alt="Admin Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column nav-flat menu-open nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item"><a class="nav-link" href="<?php echo base_url() . $this->uri->segment(1); ?>/home"><i class="nav-icon fas fa-tachometer-alt"></i>
          <p>Dashboard <span class="right badge badge-danger">Welcome</span></p>
        </a></li>
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          <i class="nav-icon fas fa-th"></i>
          <p>Menu Utama <i class="right fas fa-angle-left"></i></p>
        </a>
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Artikel <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
          $cek = $this->model_app->umenu_akses("listberita", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/listberita'><i class='far fa-circle nav-icon text-success'></i> <p>Artikel</p></a></li>";
          }

          $cek = $this->model_app->umenu_akses("kategoriberita", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/kategoriberita'><i class='far fa-circle nav-icon text-success'></i> <p>Kategori Artikel</p></a></li>";
          }

          $cek = $this->model_app->umenu_akses("tagberita", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/tagberita'><i class='far fa-circle nav-icon text-success'></i> <p>Tag Artikel</p></a></li>";
          }

          $cek = $this->model_app->umenu_akses("komentarberita", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/komentarberita'><i class='far fa-circle nav-icon text-success'></i> <p>Komentar Artikel</p></a></li>";
          }
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Foto & Video <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
          ...
          $cek = $this->model_app->umenu_akses("album", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/album'><i class='far fa-circle nav-icon text-success'></i> <p>Album Foto</p></a></li>";
          }
          $cek = $this->model_app->umenu_akses("gallery", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/gallery'><i class='far fa-circle nav-icon text-success'></i> <p>Gallery Foto</p></a></li>";
          }
          ...
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/video'><i class='far fa-circle nav-icon text-success'></i> <p>Gallery Video</p></a></li>";
          }
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Tambahan <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
          $cek = $this->model_app->umenu_akses("iklanatas", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/iklanatas'><i class='far fa-circle nav-icon text-success'></i> <p>Brosur</p></a></li>";
          }
        ...
        <ul class="nav nav-treeview">
          <?php
          $cek = $this->model_app->umenu_akses("testimoni", $this->session->id_testimoni);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/testimoni'><i class='far fa-circle nav-icon text-success'></i> <p>Testimoni Alumni</p></a></li>";
          }
        ...
        <ul class="nav nav-treeview">
          ...
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/mitra'><i class='far fa-circle nav-icon text-success'></i> <p>Mitra</p></a></li>";
          }
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Web <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Interaksi <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
          ...
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/sekilasinfo'><i class='far fa-circle nav-icon text-success'></i> <p>Pengumuman</p></a></li>";
          }
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Users <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
