    ...
    echo "
          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Judul Brosur</th>    <td><input type='text' class='form-control' name='a' required></td></tr>
                    <tr><th width='120px' scope='row'>Url Brosur</th>    <td><input type='url' class='form-control' name='b'></td></tr>
