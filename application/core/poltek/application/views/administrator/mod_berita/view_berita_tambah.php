    ...
    echo "<div class='card'>
          ...
          echo "<table class='table table-sm table-borderless'>
                  <tbody>
                    ...
                    <tr><th scope='row'>Jangan Tampil</th>        <td><input type='radio' name='f' value='Y'> Ya &nbsp; <input type='radio' name='f' value='N' checked> Tidak</td></tr>
                    ...
                    echo "</div></td></tr>
                    <tr><th scope='row'>Waktu</th>              <td><input type='text' id='datetimepicker1' data-date-format='YYYY-MM-DD HH:mm:ss' class='form-control' name='waktu' value='".date('Y-m-d H:i:s')."'></td></tr>
                  </tbody>
                  </table>
