     ...
     foreach ($beritakategori->result_array() as $r) { 
          ...
          <div class="col-md-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img style="width:210px;" src="<?php echo base_url().'asset/foto_info/'.$r[gambar];?>" alt="<?php echo $r[gambar]; ?> " /></div>
              <div class="member-info">
                <h4><a href="<?php echo base_url()."pengumuman/detail/".$r[judul_seo];?>"><?php echo $r[judul]; ?></a></h4>
                <span><?php echo tgl_indo($r['tgl_posting']);?></span>
                <p><?php echo $isi; ?></p>
                <div class="social">
