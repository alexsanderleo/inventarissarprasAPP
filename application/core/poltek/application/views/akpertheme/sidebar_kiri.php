...
<div class="block">
	<?php $rh = $this->model_utama->view_where('kategori',array('sidebar' => 5))->row_array(); ?>
		...
		<?php 
			...
			$total_komentar = $this->model_utama->view_where('komentar',array('id_berita' => $r2z['id_berita']))->num_rows();
				echo "<li>
						<div class='article-photo'>";
							if ($r2z['gambar'] ==''){
								echo "<a href='".base_url()."$r2z[judul_seo]' class='hover-effect'><img style='width:59px; height:42px;' src='".base_url()."asset/foto_berita/small_no-image.jpg' alt='' /></a>";
							}else{
								echo "<a href='".base_url()."$r2z[judul_seo]' class='hover-effect'><img style='width:59px; height:42px;' src='".base_url()."asset/foto_berita/$r2z[gambar]' alt='' /></a>";
							}
						echo "</div>
						<div class='article-content'>
							<h4><a href='".base_url()."$r2z[judul_seo]'>$r2z[judul]</a></h4>
							<span class='meta'>
								<a href='".base_url()."$r2z[judul_seo]'><span class='icon-text'>&#128340;</span>$r2z[jam], ".tgl_indo($r2z['tanggal'])."</a>
							</span>
						</div>
					  </li>";
			}
...
<div class="block">
	<?php $rhx = $this->model_utama->view_where('kategori',array('sidebar' => 6))->row_array(); ?>
...
<div class="block">
	<?php $rha = $this->model_utama->view_where('kategori',array('sidebar' => 7))->row_array(); ?>
