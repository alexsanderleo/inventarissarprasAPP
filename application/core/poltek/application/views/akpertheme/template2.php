  ...
  <section class="kotakjurnal">
       ...
       <div class="row">
            ...
            <div class="col-md-12 col-sm-12 text-center">
                ...
                <a class="btn btn-info mahasiswa" title="Profil Alumni POLTEK KALTARA" target="_blank" href="#"><i class="bx bxs-graduation margin-right-10"></i> Prospek Lulusan</a>
                <a class="btn btn-info mahasiswa" href="#"><i class="bx bxs-user margin-right-10"></i> Orang Tua</a>
                <a class="btn btn-info mahasiswa" target="_blank" href="#"><i class="bx bx-user-circle margin-right-10"></i> Laporan Kinerja</a>
            </div><br><br>
            <div class="col-md-12 col-sm-12 text-center">
                <a class="btn btn-success portal mahasiswa" target="_blank" href="#"><i class="bx bx-user-circle margin-right-10"></i> Kerja Sama</a>
                <a class="btn btn-success portal mahasiswa" title="Sebaran Alumni Luar Negeri" target="_blank" href="#"><i class="bx bxs-graduation margin-right-10"></i> Alumni Luar Negeri</a>
                <a class="btn btn-success portal mahasiswa" title="Sistem Penjaminan Mutu Internal" target="_blank" href="#"><i class="bx bxs-user margin-right-10"></i> Penjaminan Mutu </a>
                <a class="btn btn-success portal mahasiswa" title="Penelitian dan Pengabdian kepada Masyarakat" target="_blank" href="#"><i class="bx bxs-user margin-right-10"></i> Penelitian <small> Pengabdian</small> </a>
                <a class="btn btn-success portal mahasiswa" target="_blank" href="#"><i class="bx bx-user-circle margin-right-10"></i> Jurnal (Sinta 3 dan 4)</a>
            </div><br><br>
            <div class="col-md-12 col-sm-12 text-center">
                ...
                <a class="btn btn-warning portal mahasiswa text-white" target="_blank" href="#"><i class="bx bx-user-circle margin-right-10"></i> Foto Kegiatan</a>
